      ...
      <div className="p-4">
        ...
        {userData && (
          <div>
            ...
            <p>
              <span className="font-semibold">User ID:</span> {userData.
// @ts-ignore
              adminID}
            </p>
            <p>
              <span className="font-semibold">Name:</span> {userData.
// @ts-ignore
              name}
            </p>
            <p>
              <span className="font-semibold">Email:</span> {userData.
// @ts-ignore
              email}
            </p>
            <p>
              <span className="font-semibold">Password:</span> {userData.
// @ts-ignore
              password}
            </p>
            <p>
              <span className="font-semibold">Phone:</span> {userData.
// @ts-ignore
              phone}
            </p>
          </div>

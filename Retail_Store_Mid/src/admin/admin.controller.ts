...
export class AdminController {
  ...
  async addadmin(
    ...
    console.log(session);
    const res = await this.adminservice.addadmin(data);
...
signup(@Body() data: SignDTO, @UploadedFile() imageobj: Express.Multer.File) {
  ...
  if (imageobj) {
    ...
    // Call the signup method from your service
    const result = this.adminservice.signup(data);
